...
import be.kdg.prog6.restaurant.port.in.PublishAllPendingChangesCommand;
import be.kdg.prog6.restaurant.port.in.PublishAllPendingChangesUseCase;
...
@Service
@Transactional
public class PublishAllPendingChangesUseCaseImpl implements PublishAllPendingChangesUseCase {

    private final LoadMenuPort loadMenuPort;
    private final List<SaveMenuPort> saveMenuPorts;

    public PublishAllPendingChangesUseCaseImpl(
    ...
    @Override
    public void publishAllPendingChanges(PublishAllPendingChangesCommand command) {
